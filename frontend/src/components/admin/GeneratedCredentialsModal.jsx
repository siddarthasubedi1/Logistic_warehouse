...
function GeneratedCredentialsModal({
    ...
    useEffect(() => {
        ...
        /*
         * We only use sessionStorage to transfer the
         * one-time credentials from Create User
         * to Manage Users.
         */
        ...
        error
            ...
            console.error(
                "Unable to store temporary credentials:",
                error
            );
        }
        ...
        /*
         * Clear CreateUserForm's local credentials
